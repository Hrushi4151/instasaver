  ...
  return (
    <>
      <div class="-[90vw] md:w-[80vw] mx-auto my-5">
        <h1 class=" my-4 font-bold text-2xl">How to download videos & photos from Instagram online 2024</h1>
        <p className="text-lg">
          <i>
        ...
        <p className="text-lg">
          - Paste the copied Instagram link into the input box and press the{" "}
